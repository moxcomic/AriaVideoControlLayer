...
extension AriaVideoControlLayer {
    ...
    fileprivate func addItemsToTopAdapter() {
        ...
        moreItem.image = UIImage(named: "moreButton")
    ...
    fileprivate func addPortraitItemsToBottomAdapter() {
        ...
        slider.thumbImageView.image = UIImage(named: "slider")
        ...
        fullItem.image = UIImage(named: "fullScreenButton")
    ...
    fileprivate func addLandscapeItemsToBottomAdapter() {
        ...
        if playListCount > 1 {
            ...
            nextItem.image = UIImage(named: "nextVideo")
        ...
        danmakuSwitch.image = UIImage(named: "danmakuSwitchOn")
        ...
        danmakuSetting.image = UIImage(named: "danmakuSetting")
...
//        }
        ...
        if let danmakuSwitch = bottomAdapter.item(forTag: kDanmakuSwitchTag) {
            danmakuSwitch.image = isDanmakuEnable ? UIImage(named: "danmakuSwitchOn") : UIImage(named: "danmakuSwitchOff")
        }
